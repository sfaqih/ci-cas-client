                    ...
                    <?php $this->load->view('role/add'); ?>
                    <?php $this->load->view('role/edit'); ?>
                    <script>
                        $(document).ready(function(){
                            $('#insert').submit(function(e){
                                e.preventDefault();
                                insert($('#insert').serialize(), base_url + 'role/add', base_url + 'role');
                            });
                            ...
                            $(document).on('click', '.edit', function(e){
                                ...
                                if(!id_edit){
                                    ...
                                    edit(
                                        '#ModalEdit',
                                        base_url + 'role/edit/' + id_edit,
                                        {
                                            nama_peran: '#edit input[name="nama_peran"]',
                                            keterangan: '#edit textarea[name="keterangan"]'
                                        }
                                    );
                                }
                            }) 
                            ...
                            $('#edit').submit(function(e){
                                e.preventDefault();
                                var id_edit = $('tr.selected').find('input[name="id"]').val();
                                update($('#edit').serialize(), base_url + 'role/edit/' + id_edit, base_url + 'role');
                            });  

                            $(document).on('click', '.hapus', function(e){
                                var id = $('tr.selected').find('input[name="id"]').val();
                                hapus(base_url + 'role/delete', base_url + 'role', id);
                            });   
                        })
                    </script>
