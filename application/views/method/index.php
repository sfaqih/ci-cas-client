                    ...
                    <?php $this->load->view('method/add'); ?>
                    <?php $this->load->view('method/edit'); ?>
                    <script>
                        $(document).ready(function(){
                            $('#insert').submit(function(e){
                                e.preventDefault();
                                insert($('#insert').serialize(), base_url + 'method/add', base_url + 'method');
                            });
                            ...
                            $(document).on('click', '.edit', function(e){
                                ...
                                if(!id_edit){
                                    ...
                                    edit(
                                        '#ModalEdit',
                                        base_url + 'method/edit/' + id_edit,
                                        {
                                            method_name: '#edit input[name="method_name"]'
                                        }
                                    );
                                }
                            }) 
                            ...
                            $('#edit').submit(function(e){
                                e.preventDefault();
                                var id_edit = $('tr.selected').find('input[name="id"]').val();
                                update($('#edit').serialize(), base_url + 'method/edit/' + id_edit, base_url + 'method');
                            });  

                            $(document).on('click', '.hapus', function(e){
                                var id = $('tr.selected').find('input[name="id"]').val();
                                hapus(base_url + 'method/delete', base_url + 'method', id);
                            });   
                        })
                    </script>
