                    ...
                    <?php $this->load->view('pemasukan/add'); ?>
                    <?php $this->load->view('pemasukan/edit'); ?>
                    <script>
                        $(document).ready(function(){
                            $('#insert').submit(function(e){
                                e.preventDefault();
                                insert($('#insert').serialize(), base_url + 'pemasukan/add', base_url + 'pemasukan');
                            });
                            ...
                            $('.edit').click(function(e){
                                ...
                                if(!id_edit){
                                    ...
                                    edit(
                                        '#ModalEdit',
                                        base_url + 'pemasukan/edit/' + id_edit,
                                        {
                            ...
                            $('#edit').submit(function(e){
                                e.preventDefault();
                                var id_edit = $('tr.selected').find('input[name="id"]').val();
                                update($('#edit').serialize(), base_url + 'pemasukan/edit/' + id_edit, base_url + 'pemasukan');
                            });  

                            $('.hapus').click(function(e){
                                var id = $('tr.selected').find('input[name="id"]').val();
                                hapus(base_url + 'pemasukan/delete', base_url + 'pemasukan', id);
                            });   
                        })
                    </script>
